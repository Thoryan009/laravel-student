                            ...
                            <div
                                ...
                                <div class="space-y-5">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            <div class="w-full max-w-8 items-center rounded-full">
                                                <img src="{{asset('/')}}admin_assets/src/images/country/country-01.svg" alt="usa" />
                                            </div>
                                            <div>
                                                <p
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            <div class="w-full max-w-8 items-center rounded-full">
                                                <img src="{{asset('/')}}admin_assets/src/images/country/country-02.svg" alt="france" />
                                            </div>
                                            <div>
                                                <p
                                                    class="text-theme-sm font-semibold text-gray-800 dark:text-white/90">
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="flex items-center gap-3">
                                                            <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                <img src="{{asset('/')}}admin_assets/src/images/product/product-01.jpg"
                                                                    alt="Product" />
                                                            </div>
                                                            <div>
                                                                <p
                                            ...
                                            <tr>
                                                <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                                                    <div class="flex items-center col-span-4">
                                                        <div class="flex items-center gap-3">
                                                            <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                <img src="{{asset('/')}}admin_assets/src/images/product/product-02.jpg"
                                                                    alt="Product" />
                                                            </div>
                                                            <div>
                                                                <p
                                            ...
                                            <tr>
                                                <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                                                    <div class="flex items-center col-span-4">
                                                        <div class="flex items-center gap-3">
                                                            <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                <img src="{{asset('/')}}admin_assets/src/images/product/product-03.jpg"
                                                                    alt="Product" />
                                                            </div>
                                                            <div>
                                                                <p
                                            ...
                                            <tr>
                                                <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                                                    <div class="flex items-center col-span-4">
                                                        <div class="flex items-center gap-3">
                                                            <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                <img src="{{asset('/')}}admin_assets/src/images/product/product-04.jpg"
                                                                    alt="Product" />
                                                            </div>
                                                            <div>
                                                                <p
                                            ...
                                            <tr>
                                                <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                                                    <div class="flex items-center col-span-4">
                                                        <div class="flex items-center gap-3">
                                                            <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                <img src="{{asset('/')}}admin_assets/src/images/product/product-05.jpg"
                                                                    alt="Product" />
                                                            </div>
                                                            <div>
                                                                <p
