...
<!-- Mirrored from demo.tailadmin.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Apr 2025 08:42:44 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <script data-cfasync="false" nonce="92a7edf3-a589-4c59-aa0d-895feeead160">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
                    if (j.zaraz) console.error("zaraz is loaded twice");
                        ...
                        j.zaraz._v = "5850";
                        j.zaraz._n = "92a7edf3-a589-4c59-aa0d-895feeead160";
                        j.zaraz.q = [];
            ...
            <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
                ...
                <a href="index.html">
                    <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                        <img class="dark:hidden" src="{{asset('/')}}admin_assets/src/images/logo/logo.svg" alt="Logo" />
                        <img class="hidden dark:block" src="{{asset('/')}}admin_assets/src/images/logo/logo-dark.svg" alt="Logo" />
                    </span>

                    <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                        src="{{asset('/')}}admin_assets/src/images/logo/logo-icon.svg" alt="Logo" />
                </a>
            </div>
            <!-- SIDEBAR HEADER -->
                                        ...
                                        <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                                            <li>
                                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                                    ...
                                                    <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                        <img src="{{asset('/')}}admin_assets/src/images/user/user-02.jpg" alt="User"
                                            ...
                                            <li>
                                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                                    href="#">
                                                    <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                        <img src="{{asset('/')}}admin_assets/src/images/user/user-03.jpg" alt="User"
                                                            class="overflow-hidden rounded-full" />
                                                        <span
                                                            class="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
                                                    </span>
                                            ...
                                            <li>
                                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                                    href="#">
                                                    <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                        <img src="{{asset('/')}}admin_assets/src/images/user/user-04.jpg" alt="User"
                                                            class="overflow-hidden rounded-full" />
                                                        <span
                                                            class="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
                                                    </span>
                                            ...
                                            <li>
                                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                                    href="#">
                                                    <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                        <img src="{{asset('/')}}admin_assets/src/images/user/user-05.jpg" alt="User"
                                                            class="overflow-hidden rounded-full" />
                                                        <span
                                    ...
                                    <div>
                                        ...
                                        <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
                                            <a href="cdn-cgi/l/email-protection.html" class="__cf_email__"
                                                data-cfemail="3d4f5c53595250484e584f7d4d54505752135e5250">[email&#160;protected]</a>
                                        </span>
                                    </div>
...
<!-- ===== Page Wrapper End ===== -->
<script data-cfasync="false" src="{{asset('/')}}admin_assets/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
<script defer src="{{asset('/')}}admin_assets/bundle.js"></script>
